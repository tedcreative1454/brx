...
- BRX collects account email, KYC details, uploaded identity documents, payment method metadata, device/security data, and transaction records.
- KYC documents must be stored in private object storage with restricted admin access.
- BRX uses data for account security, KYC review, fraud prevention, support, and legal compliance.
...
- Unsupported network deposits may be unrecoverable.
- P2P payments can involve fraud risk.
- BRX account access, withdrawals, and trades may be delayed for review.

## KYC Policy Placeholder

- Unverified limit: 1,000 USDT.
- Verified limit: 5,000 USDT.
- Merchant limit: up to 100,000 USDT.
- Manual review may require government ID, selfie, phone number, payment method proof, and additional documentation.
